...
<div id="wrapper">
	...
	<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		...
		<a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
			...
			<div class="sidebar-brand-text mx-3">JF Admin</div>
		</a>
		...
		<li class="nav-item">
			...
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					<a class="collapse-item" href="#" data-toggle="modal" data-target="#addParagraphModal">Paragraph</a>
					<a class="collapse-item" href="#" data-toggle="modal" data-target="#addProjectModal">Project</a>
				</div>
			</div>
		</li>
	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown no-arrow">
						<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<span class="mr-2 d-none d-lg-inline text-gray-600 small">Jamila Ferron</span>
							<img class="img-profile rounded-circle" src="img/IMG_3858.JPG">
						</a>
			...
			<div class="container-fluid">
				...
				<div class="d-sm-flex align-items-center justify-content-between mb-4 message">
					<?php
					if (isset($message)){
						echo $message;
					}
			...
			<div class="container-fluid">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Paragraphs</h6>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-bordered" id="paragraphTable" width="100%" cellspacing="0">
								<thead>
								<tr>
									<th>Paragraph</th>
									<th>Edit</th>
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
				<div class="copyright text-center my-auto">
					<span>Copyright &copy; Jamila Ferron 2019</span>
				</div>
			</div>
		</footer>
		<!-- End of Footer -->
...
<!-- Add Paragraph Modal-->
<div class="modal fade" id="addParagraphModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Add New Paragraph</h5>
			...
			<form method="POST" action="dashboard.php" class="add-form">
				<div class="modal-body">
					<div class="form-group">
						<textarea class="form-control" name="new-paragraph" rows="3" placeholder="Enter a paragraph"></textarea>
					</div>
				</div>
				<div class="modal-footer">
					<button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
					<input class="btn btn-primary" type="submit" name="add_submit" value="Add">
				</div>
			</form>
		</div>
	</div>
